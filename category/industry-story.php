...
<body>
  ...
  <?php
     $data=0;
     $sql="SELECT * FROM category where category='Industry-Story' and is_active=0";
     $result=$pdo->query($sql);
     $data=$result->fetch();
     if(empty($data)){
        $result=$pdo->query("SELECT * FROM subcategory where sub_category='Industry-Story' and is_active=0");
        $data=$result->fetch();
     }
   ?>
  <!--<section>-->
...
<div class="col-lg-2 col-3">
  <div class="bg-white text-center p-2">
      ...
      <div>
         <img src="../images/ads/<?php echo $globalad[5]['ad_code']; ?>" alt="ads11" />
        </div>
...
<!-- !advertisment area -->
      ...
      <div class="col-lg-8 col-6 px-lg-5 px-0">
        ...
        <div class="row g-3">
          <?php $sql="SELECT * FROM news where (category='Industry-Story' or sub_category='Industry-Story') and is_active=0 ORDER BY id DESC";
           $result=$pdo->query($sql);
          $data=$result->fetchAll();
          foreach ($data as $value) {
              $a = strip_tags( $value['heading']);
...
<!-- advertisment area -->
   <div class="col-lg-2 col-3">
      ...
      <div>
        ...
        <div>
        <a href="https://www.apisindia.com/" target="_blank">
