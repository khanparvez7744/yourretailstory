...
<div class="container">
  <div class="row py-sm-5 pt-3 px-2 px-sm-0">
    <div class="col-lg-6 col-md-12 footIcon">
      ...
      <p class="py-sm-2 py-0 fs-16 text-justify"><?php echo $setting['about_content']; ?></p>
      <ul class="list-style-none footeraboutLi">
...
<p class="mt-3 fs-14" id="message"></p>
    ...
    <li class="fs-14 mt-2"><a href="/terms" class="text-white text-decoration-none">TERMS & CONDITION</a></li>
    <li class="fs-14 mt-2"><a href="/privacy" class="text-white text-decoration-none">PRIVACY POLICY</a></li>
