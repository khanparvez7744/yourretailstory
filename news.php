        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="nndMenubar">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link text-light text-capitalize" href="industry-story.php"><i class="fa fa-industry"></i> Industry Story</a>
              </li>

              <li class="nav-item">
                <a class="nav-link text-light text-capitalize" href="startup-story.php"><i class="fas fa-handshake"></i> StartUp Story</a>
              </li>

              <li class="nav-item">
                <a class="nav-link text-light text-capitalize" href="wonder-woman.php"><i class="fas fa-female"></i> Wonder Woman</a>
              </li>

              <li class="nav-item">
                <a class="nav-link text-light text-capitalize" href="expert-opinion.php"><i class="fa fa-hat-cowboy"></i> Expert Opinion</a>
              </li>

              <li class="nav-item">
                <a class="nav-link text-light text-capitalize" href="inside-edge.php"><i class="far fa-hand-point-down"></i> Inside Edge</a>
              </li>

              <li class="nav-item">
                <a class="nav-link text-light text-capitalize" href="marketing-campaign.php"><i class="fas fa-building"></i> Marketing Campaign</a>
              </li>
...
?>
    <div class="row">
      <div class="col-sm-9 pe-sm-5 pe-3">
        ...
        //   echo $col1;
      echo '<p class="text-justify fsize-16">$text</p>';
         ?>
...
<div class=""><div class="text-center">
   <a href="https://www.facebook.com/sharer/sharer.php?u=https://yourretailstory.com/category/news.php?cat=<?php echo $data['id'] ?>" class="me-4 d-inline-block" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Facebook"><i class="fab fa-facebook text-danger fs-2"></i></a>
                <a href="https://twitter.com/share?u=https://yourretailstory.com/category/news.php?cat=<?php echo $data['id'] ?>" class="me-4 d-inline-block" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Twitter"><i class="fab fa-twitter text-danger fs-2"></i></a>
                <a href="https://www.linkedin.com/shareArticle?mini=true&u=https://yourretailstory.com/category/news.php?cat=<?php echo $data['id'] ?>" class="me-4 d-inline-block" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Linkedin"><i class="fab fa-linkedin text-danger fs-2"></i></a>
                <a href="https://api.whatsapp.com/send?text=https://yourretailstory.com/category/news.php?cat=<?php echo $data['id'] ?>" class="me-4 d-inline-block" data-action="share/whatsapp/share" onClick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on whatsapp"><i class="fab fa-whatsapp text-danger fs-2"></i></a>
</div></div>
